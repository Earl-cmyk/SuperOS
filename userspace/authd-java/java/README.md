...
**SuperOS Authentication Daemon (Java)**

`authd-java` is a **user-space authentication and identity mediation service** for SuperOS.  
...
UI ──► authd-java ──► Orchestrator ──► Kernel
(identity)      (policy)        (law)

```

- `authd-java` answers **who**
...
If `authd-java` crashes or is unavailable:
