...
**SuperOS Authentication Daemon (kotlin)**

`authd-kotlin` is a **user-space authentication and identity mediation service** for SuperOS.  
...
UI ──► authd-kotlin ──► Orchestrator ──► Kernel
(identity)      (policy)        (law)

```

- `authd-kotlin` answers **who**
...
If `authd-kotlin` crashes or is unavailable:
